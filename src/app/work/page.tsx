      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10 lg:py-12">
        <header className="mb-6 sm:mb-8">
          ...
          <p className="mt-2 text-sm text-slate-400 max-w-xl">
            A unified list of tasks and assignments across all of your projects.
          </p>
        </header>

        <section className="rounded-2xl border border-slate-800 bg-slate-900/70 px-4 py-8 sm:px-6 sm:py-10 text-sm text-slate-400">
          We&apos;ll eventually pull in tasks from each project and support
          multi‑select, drag‑and‑drop, and quick actions here.
        </section>
      </div>
    </main>
  );
